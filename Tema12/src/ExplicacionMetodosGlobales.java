...
public class ExplicacionMetodosGlobales {
    ...
    static void ejemploDeContainsAll(){
        ...
        coleccionClients1.add(new Cliente("001","Paco", "17/10/1993"));
        coleccionClients1.add(new Cliente("002","Marta", "05/05/2005"));

        //COLECCIÓN 2
        Collection coleccionClients2  = new ArrayList<>();;
        coleccionClients2.add(new Cliente("001","Paco", "17/10/1993"));
        coleccionClients2.add(new Cliente("002","Marta", "05/05/2005"));
        ...
        coleccionClients1.add(nuevoCliente);
    ...
    static void ejemploDeRemoveAll(){
        ...
        coleccionClients1.add(new Cliente("001","Paco", "17/10/1993"));
        coleccionClients1.add(new Cliente("002","Marta", "05/05/2005"));
        coleccionClients1.add(new Cliente("003","Fernando", "01/07/2000"));
